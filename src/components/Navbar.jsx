...
<nav class="border">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <div class="flex items-center rtl:space-x-reverse">
        <img src="https://i.postimg.cc/zvvpyTCy/protected.png" class="h-8" alt="Reg Logo" />
        <span class="ml-2 self-center text-2xl font-semibold whitespace-nowrap ">Regulation</span>
    </div>
